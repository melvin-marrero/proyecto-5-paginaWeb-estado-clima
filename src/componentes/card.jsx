...
export default function Card({showdingData,loudingData,weather, forecast}) {
    var today = new Date();
            ...
            <div className="row g-0">
                ...
                <div className="col-md-8 dato">
                  <div className="card-body text-start mt-2">
                    <h5 className="card-text-mx">Temperatura máxima: {(weather.main.temp_max - 273.15).toFixed(1)}ºC</h5>
                    <h5 className="card-text-b">Temperatura mínima: {(weather.main.temp_min - 273.15).toFixed(1)}ºC</h5>
                    <h5 className="card-text-mx">sensación térmica: {(weather.main.feels_like- 273.15).toFixed(1)}ºC</h5>
                    <h5 className="card-text-b">Humedad: {weather.main.humidity}%</h5>
                    <h5 className="card-text-v">Velocidad del viento: {weather.wind.speed}m/s</h5>
                  </div>
                
                <hr/>

                <div className="pronostico row mt-4">
                    <div className="col">
                       <p className="p-pronostico">{forecastDate3}h</p>
                    ...
                    <div className="col">
                        <p className="p-pronostico">{forecastDate6}h</p>
                    ...
                    <div className="col">
                       <p className="p-pronostico">{forecastDate9}h</p>
